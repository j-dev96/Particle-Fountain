...
Myrand_generate::Myrand_generate(){
...
double Myrand_generate::rand(double low, double high){
	return (ran1()*(high - low))+low;
}

int Myrand_generate::rand(int low, int high){
...
double Myrand_generate::box_muller(double m, double s)	{				        
	int idnum = -1;
	double x1, x2, w, y1;
	static double y2;
